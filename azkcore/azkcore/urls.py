...
from apps.home_fuctions.scan_web.views import scan_web
from apps.home_fuctions.dns_subfinder.views import dns_subfinder
...
urlpatterns = [
    ...
    path("home/scan-web/", scan_web, name="scan_web"),
    path("home/dns-subfinder/", dns_subfinder, name="dns_subfinder"),
